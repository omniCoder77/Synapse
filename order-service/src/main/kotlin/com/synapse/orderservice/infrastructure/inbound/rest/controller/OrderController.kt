package com.synapse.orderservice.infrastructure.inbound.rest.controller

import com.synapse.orderservice.domain.port.driver.OrderService
import com.synapse.orderservice.infrastructure.inbound.rest.rest.dto.CreateOrderRequest
...
class OrderController(private val orderService: OrderService) {
    ...
    fun createOrder(
        ...
        return orderService.createOrder(
            ...
            ResponseEntity.accepted().body(it.toString())
        }
    }
}